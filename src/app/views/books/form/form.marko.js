...
function render(input, out, __component, component, state) {
  ...
  out.w("<h1>Book Catalogue</h1><form action=\"/livros\" method=\"post\">");
  ...
  out.w("<div><label for=\"titulo\">Titulo:</label><input type=\"text\" id=\"titulo\" name=\"titulo\" value=\"" +
    ...
    "\" placeholder=\"Type the title\"></div><div><label for=\"preco\">Preço:</label><input type=\"text\" id=\"preco\" name=\"preco\" value=\"" +
    marko_escapeXmlAttr(data.livro.preco) +
    "\" placeholder=\"150.25\"></div><div><label for=\"descricao\">Description:</label><textarea cols=\"20\" rows=\"10\" id=\"descricao\" name=\"descricao\" placeholder=\"About the book\">" +
